...
class test_merge_commit_payload_handler(payload_handler_base):
    ...
    def test_pr(self):
        """
        Test that the merge commit payload handler correctly processes PR webhooks
        """
        log_statements = [
    ...
    def test_pr_commit_to_master(self):
        """
        Test that the merge commit payload handler correctly processes commit to master webhooks
        """
        log_statements = [
    ...
    def test_pr_sync(self):
        """
        Test that the merge commit payload handler correctly processes PR sync webhooks
        """
        log_statements = [
                "Is pull request open? False",
                "Is pull request sync? True",
